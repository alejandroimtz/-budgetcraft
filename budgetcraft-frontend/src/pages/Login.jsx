...
import { Wallet, ArrowRight, Lock, Mail, Shield, BarChart3, Sparkles, Zap, LogOut, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-emerald-100 text-lg">Tu asistente financiero inteligente</p>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <div className="flex items-center space-x-2 text-emerald-100">
              ...
              <span className="text-sm font-medium">Más de 10,000 usuarios confían en nosotros</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl shadow-black/40">
            {user && (
              <div className="mb-6 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center justify-between">
                ...
                <button
                  onClick={() => { logout(); onSwitchToRegister(); }}
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-slate-100 mb-1">Bienvenido de nuevo</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-700 bg-slate-950 text-emerald-500 focus:ring-emerald-500/30" />
              ...
              >
                <span>{loading ? 'Ingresando...' : 'Entrar a la App'}</span>
